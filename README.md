...
This is a good template for applications that uses both rails and react redux this as the frontend.
...
```sh
  git clone https://github.com/edahigure/hello-react-front-end.git
```
